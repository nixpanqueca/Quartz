...
# [104] PutPixel(RWidth div 2 + 14, RHeight - 25, 0);
	movl	U_$VIDEO_$$_RWIDTH,%edx
	movl	%edx,%eax
	shrl	$31,%eax
	addl	%eax,%edx
	...
	movb	$0,%cl
	call	VIDEO_$$_PUTPIXEL$LONGINT$LONGINT$BYTE
# [107] DrawBMP('SPRITES\FOLDER.BMP', 6, RHeight - 20);
	movl	U_$VIDEO_$$_RHEIGHT,%eax
	leal	-20(%eax),%ecx
	movl	$6,%edx
	movl	$_$SEEK$_Ld1,%eax
	call	VIDEO_$$_DRAWBMP$PCHAR$LONGINT$LONGINT
# [109] FillRect(29,RHeight-25, 1, 25, 0);
	pushl	$25
	pushl	$0
	movl	U_$VIDEO_$$_RHEIGHT,%eax
	leal	-25(%eax),%edx
...
# [113] begin
	pushl	%ebp
	movl	%esp,%ebp
# [114] FillPatternRect(0,26, RWidth, RHeight - 26, MacGray,0,$0F);
	movl	U_$VIDEO_$$_RHEIGHT,%eax
	leal	-26(%eax),%eax
	pushl	%eax
...
# [119] begin
	pushl	%ebp
	movl	%esp,%ebp
# [120] if StrEqual(ActiveWindow, 'Seek') then
	movl	U_$SEEK_$$_ACTIVEWINDOW,%eax
	movl	$_$SEEK$_Ld2,%edx
	call	BUTTONS_$$_STREQUAL$PCHAR$PCHAR$$BOOLEAN
	testb	%al,%al
	jne	.Lj35
	jmp	.Lj36
.Lj35:
# [122] if not isMenuOpen then
	cmpb	$0,U_$SEEK_$$_ISMENUOPEN
	je	.Lj37
	jmp	.Lj38
.Lj37:
# [124] FillRect(0, 26, 165, 250, $0F);
	pushl	$250
	pushl	$15
	movl	$165,%ecx
	movl	$26,%edx
...
# [144] FillRect(0, 25, RWidth, 1, 0);
	...
	movl	$0,%eax
	call	VIDEO_$$_FILLRECT$LONGINT$LONGINT$LONGINT$LONGINT$BYTE
# [146] PutSymbol(7,7, '#', 12);
	pushl	$12
	movb	$35,%cl
	movl	$7,%edx
	movl	$7,%eax
	call	VIDEO_$$_PUTSYMBOL$LONGINT$LONGINT$CHAR$LONGINT
# [147] PutPixel(13,13, 0);
	movb	$0,%cl
	movl	$13,%edx
	movl	$13,%eax
	call	VIDEO_$$_PUTPIXEL$LONGINT$LONGINT$BYTE
# [148] PutPixel(12,13, 0);
	movb	$0,%cl
	movl	$13,%edx
	movl	$12,%eax
	call	VIDEO_$$_PUTPIXEL$LONGINT$LONGINT$BYTE
# [149] PutPixel(13,12, 0);
	movb	$0,%cl
	movl	$12,%edx
	movl	$13,%eax
	call	VIDEO_$$_PUTPIXEL$LONGINT$LONGINT$BYTE
# [150] PutPixel(12,12, 0);
	movb	$0,%cl
	movl	$12,%edx
	movl	$12,%eax
	call	VIDEO_$$_PUTPIXEL$LONGINT$LONGINT$BYTE
# [151] AddButton(7,7, 12, 12, @MainMenu);
	pushl	$12
...
# [163] FillRect(RWidth - 2,2, 2, 1, 0);
	...
	movl	$2,%edx
	call	VIDEO_$$_FILLRECT$LONGINT$LONGINT$LONGINT$LONGINT$BYTE
# [164] PutPixel(RWidth - 1,3, 0);
	movl	U_$VIDEO_$$_RWIDTH,%eax
	leal	-1(%eax),%eax
	movb	$0,%cl
	movl	$3,%edx
	call	VIDEO_$$_PUTPIXEL$LONGINT$LONGINT$BYTE
# [165] PutPixel(RWidth - 1,4, 0);
	movl	U_$VIDEO_$$_RWIDTH,%eax
	leal	-1(%eax),%eax
	movb	$0,%cl
	movl	$4,%edx
...
.section .text.n_seek_$$_highres,"x"
	.balign 16,0x90
SEEK_$$_HIGHRES:
# [169] begin // for now this will be the same as 480p
	pushl	%ebp
	movl	%esp,%ebp
# [171] FillRect(0, 0, RWidth, 25, $0F);
	pushl	$25
	pushl	$15
	movl	U_$VIDEO_$$_RWIDTH,%ecx
	movl	$0,%edx
...
# [172] FillRect(0, 26, RWidth, 1, 0);
	...
	movl	$0,%eax
	call	VIDEO_$$_FILLRECT$LONGINT$LONGINT$LONGINT$LONGINT$BYTE
# [174] PutSymbol(7,7, '#', 12);
	pushl	$12
	movb	$35,%cl
	movl	$7,%edx
	movl	$7,%eax
	call	VIDEO_$$_PUTSYMBOL$LONGINT$LONGINT$CHAR$LONGINT
# [175] PutPixel(13,13, 0);
	movb	$0,%cl
	movl	$13,%edx
	movl	$13,%eax
	call	VIDEO_$$_PUTPIXEL$LONGINT$LONGINT$BYTE
# [176] PutPixel(12,13, 0);
	movb	$0,%cl
	movl	$13,%edx
	movl	$12,%eax
	call	VIDEO_$$_PUTPIXEL$LONGINT$LONGINT$BYTE
# [177] PutPixel(13,12, 0);
	movb	$0,%cl
	movl	$12,%edx
	movl	$13,%eax
	call	VIDEO_$$_PUTPIXEL$LONGINT$LONGINT$BYTE
# [178] PutPixel(12,12, 0);
	movb	$0,%cl
	movl	$12,%edx
	movl	$12,%eax
	call	VIDEO_$$_PUTPIXEL$LONGINT$LONGINT$BYTE
...
# [190] FillRect(RWidth - 2,2, 2, 1, 0);
	...
	movl	$2,%edx
	call	VIDEO_$$_FILLRECT$LONGINT$LONGINT$LONGINT$LONGINT$BYTE
# [191] PutPixel(RWidth - 1,3, 0);
	movl	U_$VIDEO_$$_RWIDTH,%eax
	leal	-1(%eax),%eax
	movb	$0,%cl
	movl	$3,%edx
	call	VIDEO_$$_PUTPIXEL$LONGINT$LONGINT$BYTE
# [192] PutPixel(RWidth - 1,4, 0);
	movl	U_$VIDEO_$$_RWIDTH,%eax
	leal	-1(%eax),%eax
	movb	$0,%cl
	movl	$4,%edx
...
.section .rodata.n__$SEEK$_Ld6,"d"
	.balign 4
.globl	_$SEEK$_Ld6
_$SEEK$_Ld6:
	.ascii	"Special\000"
